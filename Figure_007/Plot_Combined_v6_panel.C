...
pull_gg->SetLineWidth(2);			
        ...
        TLegend *leg = new TLegend(0.38,0.08,0.63,0.7,"");
...
TLegend *leg2 = new TLegend(0.67,0.08,0.92,0.7,"");
...
leg2->SetTextFont(42);
	...
	Standard_Fit_atlas->GetYaxis()->SetRangeUser(0.00000000015,10.);
        ...
        Standard_Fit_dijet->GetYaxis()->SetRangeUser(0.00000000015,10.);
        ...
        Standard_Fit_moddijet->GetYaxis()->SetRangeUser(0.000000000015,10.);
        ...
        h_MC->GetYaxis()->SetRangeUser(0.000000000015,10.);
...
TCanvas *panel = new TCanvas("panel","panel",1800,600); 
panel->cd();
panel->SetBottomMargin(0.);

TLine *line1 = new TLine(0.03,0.05,0.95,0.05);
TLine *line2 = new TLine(0.01,0.75,0.968,0.75);
TLine *line3 = new TLine(0.01,0.02,0.01,0.75);
TLine *line4 = new TLine(0.968,0.02,0.968,0.75);
