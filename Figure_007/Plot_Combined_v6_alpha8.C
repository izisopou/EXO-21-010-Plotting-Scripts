...
void Plot_Combined_v6_alpha8(){
	...
	/*double gg_8TeV_obs_limit = 0.0000024;
        ...
        double gg_8TeV_obs_limit = 2.4e-5;
        double qq_2TeV_obs_limit = 4.9e-3;
        double qq_4TeV_obs_limit = 7.8e-5;
/*double gg_8TeV_obs_limit = 0.0000024;
        double qq_4TeV_obs_limit = 0.0000045;
        double qq_2TeV_obs_limit = 0.00038;*/
	...
	TFile *f_RM= new TFile("HISTOS_4J_Alldata_SR_alphabin8.root");
...
/*TFile *fout;
 ...
 fout = new TFile("test_pulls_alpha8.root","RECREATE");
...
TFile *fout;
 ...
 fout = new TFile("Mass_spectrum_alpha8_canvas_FR_v2.root","RECREATE");
