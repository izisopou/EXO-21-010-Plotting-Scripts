...
void Plot_Combined_v6_alpha7(){
	...
	double gg_8TeV_obs_limit = 0.61e-5;
        double qq_4TeV_obs_limit = 2.1e-5;
        double qq_2TeV_obs_limit = 1.5e-3;
...
/*double gg_8TeV_obs_limit = 0.0000024;
	...
	char *image_name = "_2016_2017_Shapes_tot_err_alpha7_proper";

	TFile *f_RM= new TFile("HISTOS_4J_Alldata_SR_alphabin7.root");
	TFile *f_SF_atlas= new TFile("DijetFitResult_PFDijet2017_4J_alphabin7_atlas_test.root");
        TFile *f_SF_dijet= new TFile("DijetFitResult_PFDijet2017_4J_alphabin7_dijet_test.root");
        TFile *f_SF_moddijet= new TFile("DijetFitResult_PFDijet2017_4J_alphabin7_moddijet_test.root");
        TFile *f_MC= new TFile("QCD2017_Standardcuts_M4Jgt1p6_nobreak_alpha7.root");
// Initial roofit /afs/cern.ch/work/m/mdiamant/public/forNiki/alphagt0p1/atlas/DijetFitResults_PFDijet2017_4J_alphabin7.root");
	...
	TFile *f_gg= new TFile("ResonanceShapes_Suu8600_Chi2150_SR_alphabin7.root");
...
TFile *f_qq= new TFile("ResonanceShapes_Suu2000_Chi500_SR_alphabin7.root");
...
TFile *f_qg= new TFile("ResonanceShapes_Suu5000_Chi1250_SR_alphabin7.root");
...
leg2->SetTextSize(0.04);
	...
	pad1r->SetRightMargin(0.); //0.05
	pad1r->SetTopMargin(0.); //0.05
	pad1r->SetLeftMargin(0.1);
...
//l->DrawLatex(0.2,0.88,"#bf{CMS} #scale[0.7]{#it{Preliminary}}");
	...
	TVirtualPad *pad2r ;
	pad2r = c1->GetPad(2);
	pad2r->SetLeftMargin(0.1);
	pad2r->SetPad(0.,0.02,1,0.36); //0.,0.02,1,0.37
	pad2r->SetBottomMargin(0.15); //0.35
	pad2r->SetRightMargin(0.); //0.05
	pad2r->Draw();
	pad2r->cd(); 
	pad2r->cd()->SetLogx(1);
	//pad2r->SetGridx();
...
/*TFile *fout;
 ...
 fout = new TFile("test_pulls_alpha7.root","RECREATE");
...
TFile *fout;
 ...
 fout = new TFile("Mass_spectrum_alpha7_canvas_FR_v2.root","RECREATE");
