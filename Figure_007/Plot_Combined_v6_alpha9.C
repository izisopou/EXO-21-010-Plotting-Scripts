...
void Plot_Combined_v6_alpha9(){
	...
	double gg_8TeV_obs_limit = 0.63e-5;
        double qq_4TeV_obs_limit = 1.8e-5;
        double qq_2TeV_obs_limit = 1.3e-3;
	 
	 
	 //ROOT::Math::MinimizerOptions::SetDefaultMaxFunctionCalls( 20000);   //set the number of parameter searches for convergence

	char *image_name = "_2016_2017_Shapes_tot_err_alpha9_proper";

	TFile *f_RM= new TFile("HISTOS_4J_Alldata_SR_alphabin9.root");
	TFile *f_SF_atlas= new TFile("DijetFitResult_PFDijet2017_4J_alphabin9_atlas_test.root");
        TFile *f_SF_dijet= new TFile("DijetFitResult_PFDijet2017_4J_alphabin9_dijet_test.root");
        TFile *f_SF_moddijet= new TFile("DijetFitResult_PFDijet2017_4J_alphabin9_moddijet_test.root");
        TFile *f_MC= new TFile("QCD2017_Standardcuts_M4Jgt1p6_nobreak_alpha9.root");
// Initial roofit /afs/cern.ch/work/m/mdiamant/public/forNiki/alphagt0p1/atlas/DijetFitResults_PFDijet2017_4J_alphabin9.root");
	...
	TFile *f_gg= new TFile("ResonanceShapes_Suu8600_Chi2150_SR_alphabin9.root");
...
TFile *f_qq= new TFile("ResonanceShapes_Suu2000_Chi500_SR_alphabin9.root");
...
TFile *f_qg= new TFile("ResonanceShapes_Suu5000_Chi1250_SR_alphabin9.root");
...
pull_qq->SetLineWidth(3);
pull_qg->SetLineWidth(3);
pull_gg->SetLineWidth(3);			
...
leg2->SetTextSize(0.04);
	...
	Standard_Fit_atlas->GetYaxis()->SetRangeUser(0.00000000015,9.);
        ...
        Standard_Fit_moddijet->GetYaxis()->SetRangeUser(0.000000000015,9.);
        ...
        h_MC->GetYaxis()->SetRangeUser(0.000000000015,9.);
	...
	pull_SF_atlas->SetStats(0);
	pull_SF_dijet->SetStats(0);
	pull_SF_moddijet->SetStats(0);
	...
	TVirtualPad *pad1r; 
	pad1r = c1->GetPad(1);
	pad1r->SetPad(0.,0.38,1.,1.);
	pad1r->SetRightMargin(0.05); //0.05
	pad1r->SetTopMargin(0.); //0.05
	pad1r->SetLeftMargin(0.);
...
//
        ...
        h_MC->GetYaxis()->SetTitleSize(0.); //0.07
...
TPaveText *pave3 = new TPaveText(0.4,0.8,0.7,0.9,"NDC");
 pave3->AddText("0.26 < #alpha < 0.28");
...
//l->DrawLatex(0.2,0.88,"#bf{CMS} #scale[0.7]{#it{Preliminary}}");
	...
	TVirtualPad *pad2r ;
	pad2r = c1->GetPad(2);
	pad2r->SetLeftMargin(0.);
	pad2r->SetPad(0.,0.02,1,0.36);
	pad2r->SetBottomMargin(0.15); //0.35
	...
	pull_SF_atlas->GetXaxis()->SetTitleSize(2*0.); //2*0.06
	pull_SF_atlas->GetYaxis()->SetTitleSize(2*0.); //2*0.06
	pull_SF_atlas->GetXaxis()->SetLabelSize(2*0.0);
	pull_SF_atlas->GetYaxis()->SetLabelSize(0.09);
	pull_SF_atlas->GetXaxis()->SetLabelOffset(1000);
	pull_SF_atlas->GetYaxis()->SetLabelOffset(0.02);
...
//
        ...
        pull_SF_dijet->GetXaxis()->SetTitleSize(2*0.); //2*0.06
        pull_SF_dijet->GetYaxis()->SetTitleSize(2*0.); //2*0.06
        pull_SF_dijet->GetXaxis()->SetLabelSize(2*0.07);
        pull_SF_dijet->GetYaxis()->SetLabelSize(0.09);
	pull_SF_dijet->GetYaxis()->SetLabelOffset(0.02);
        ...
        pull_SF_moddijet->GetXaxis()->SetTitleSize(2*0.); //2*0.06
        pull_SF_moddijet->GetYaxis()->SetTitleSize(2*0.); //2*0.06
        pull_SF_moddijet->GetXaxis()->SetLabelSize(2*0.07);
        pull_SF_moddijet->GetYaxis()->SetLabelSize(0.09);
	pull_SF_moddijet->GetYaxis()->SetLabelOffset(0.02);
        ...
        pull_MC->GetXaxis()->SetTitleSize(2*0.); //2*0.06
        pull_MC->GetYaxis()->SetTitleSize(2*0.); //2*0.06
	...
	pull_SF_atlas->GetYaxis()->SetTitleSize(0.); 
...
/*TFile *fout;
 ...
 fout = new TFile("test_pulls_alpha9.root","RECREATE");
...
TFile *fout;
 ...
 fout = new TFile("Mass_spectrum_alpha9_canvas_FR_v2.root","RECREATE");
