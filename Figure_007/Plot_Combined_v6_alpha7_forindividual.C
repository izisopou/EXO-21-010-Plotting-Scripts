...
void Plot_Combined_v6_alpha7_forindividual(){
	...
	double gg_8TeV_obs_limit = 6.0232950e-06;
        double qq_4TeV_obs_limit = 2.1489414e-05;
        double qq_2TeV_obs_limit = 0.0014459801;
