...
void create_yaml_forHEPData_spectrum_bins_individual(){


TFile *f = new TFile("forHEPData_mass_spectrum_alphabin9.root","READ");

TGraphAsymmErrors *g = (TGraphAsymmErrors*)f->Get("Graph_from_h_FourjetMass");

ofstream yaml_file;
yaml_file.open("m4j_spectrum_alphabin9.yaml");
