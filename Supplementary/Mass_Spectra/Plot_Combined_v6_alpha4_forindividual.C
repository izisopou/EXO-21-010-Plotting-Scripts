...
void Plot_Combined_v6_alpha4_forindividual(){
	...
	double gg_8TeV_obs_limit = 4.8297600e-07;
        double qq_4TeV_obs_limit = 1.4982800e-06;
        double qq_2TeV_obs_limit = 0.00011395513;
	 
	 
	 //ROOT::Math::MinimizerOptions::SetDefaultMaxFunctionCalls( 20000);   //set the number of parameter searches for convergence

	char *image_name = "_2016_2017_Shapes_tot_err_alpha4_proper";

	TFile *f_RM= new TFile("HISTOS_4J_Alldata_SR_alphabin4.root");
	TFile *f_SF_atlas= new TFile("DijetFitResult_PFDijet2017_4J_alphabin4_atlas_test.root");
        TFile *f_SF_dijet= new TFile("DijetFitResult_PFDijet2017_4J_alphabin4_dijet_test.root");
        TFile *f_SF_moddijet= new TFile("DijetFitResult_PFDijet2017_4J_alphabin4_moddijet_test.root");
        TFile *f_MC= new TFile("QCD2017_Standardcuts_M4Jgt1p6_nobreak_alpha4.root");
// Initial roofit /afs/cern.ch/work/m/mdiamant/public/forNiki/alphagt0p1/atlas/DijetFitResults_PFDijet2017_4J_alphabin7.root");
	...
	TFile *f_gg= new TFile("ResonanceShapes_Suu8600_Chi2150_SR_alphabin4.root");
...
TFile *f_qq= new TFile("ResonanceShapes_Suu2000_Chi500_SR_alphabin4.root");
...
TFile *f_qg= new TFile("ResonanceShapes_Suu5000_Chi1250_SR_alphabin4.root");
