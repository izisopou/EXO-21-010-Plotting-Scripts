...
void Plot_Combined_v6_alpha6_forindividual(){
	...
	double gg_8TeV_obs_limit = 1.3883985e-06;
        double qq_4TeV_obs_limit = 4.9554680e-06;
        double qq_2TeV_obs_limit = 0.00041374359;
	 
	 
	 //ROOT::Math::MinimizerOptions::SetDefaultMaxFunctionCalls( 20000);   //set the number of parameter searches for convergence

	char *image_name = "_2016_2017_Shapes_tot_err_alpha6_proper";

	TFile *f_RM= new TFile("HISTOS_4J_Alldata_SR_alphabin6.root");
	TFile *f_SF_atlas= new TFile("DijetFitResult_PFDijet2017_4J_alphabin6_atlas_test.root");
        TFile *f_SF_dijet= new TFile("DijetFitResult_PFDijet2017_4J_alphabin6_dijet_test.root");
        TFile *f_SF_moddijet= new TFile("DijetFitResult_PFDijet2017_4J_alphabin6_moddijet_test.root");
        TFile *f_MC= new TFile("QCD2017_Standardcuts_M4Jgt1p6_nobreak_alpha6.root");
// Initial roofit /afs/cern.ch/work/m/mdiamant/public/forNiki/alphagt0p1/atlas/DijetFitResults_PFDijet2017_4J_alphabin7.root");
	...
	TFile *f_gg= new TFile("ResonanceShapes_Suu8600_Chi2150_SR_alphabin6.root");
...
TFile *f_qq= new TFile("ResonanceShapes_Suu2000_Chi500_SR_alphabin6.root");
...
TFile *f_qg= new TFile("ResonanceShapes_Suu5000_Chi1250_SR_alphabin6.root");
...
pull_gg->SetLineWidth(2);			
        ...
        TLegend *leg = new TLegend(0.65,0.5,0.85,0.9); //0.6,0.5,0.8,0.9
...
TPaveText *pave3 = new TPaveText(0.35,0.63,0.65,0.73,"NDC");
 pave3->AddText("0.20 < #alpha < 0.22");
...
l->DrawLatex(0.23,0.79,"#splitline{#bf{CMS}}{#scale[0.7]{#it{Supplementary}}}");
    //l->SetTextFont(52);
    l->SetTextFont(42);
    l->SetTextSize(0.055);
    l->DrawLatex(0.690,0.953,"138 fb^{-1} (13 TeV)"); //0.68,0.953
	//paveCMS2->Draw("same");
...
//
	...
	//c1->SaveAs("Ilias_scale.pdf");
TFile *fout;

 fout = new TFile("../../Figure_7/test_pulls_alpha6_ilias.root","RECREATE");
