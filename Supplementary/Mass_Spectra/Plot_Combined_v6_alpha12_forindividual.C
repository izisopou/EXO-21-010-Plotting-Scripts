...
void Plot_Combined_v6_alpha12_forindividual(){
	...
	double gg_8TeV_obs_limit = 1.0185840e-06;
        double qq_4TeV_obs_limit = 1.5744820e-06;
        double qq_2TeV_obs_limit = 0.00013323953;
	...
	TFile *f_RM= new TFile("HISTOS_4J_Alldata_SR_alphabin12.root");
	TFile *f_SF_atlas= new TFile("DijetFitResult_PFDijet2017_4J_alphabin12_atlas_test.root");
        TFile *f_SF_dijet= new TFile("DijetFitResult_PFDijet2017_4J_alphabin12_dijet_test.root");
        TFile *f_SF_moddijet= new TFile("DijetFitResult_PFDijet2017_4J_alphabin12_moddijet_test.root");
        TFile *f_MC= new TFile("QCD2017_Standardcuts_M4Jgt1p6_nobreak_alpha12.root");
// Initial roofit /afs/cern.ch/work/m/mdiamant/public/forNiki/alphagt0p1/atlas/DijetFitResults_PFDijet2017_4J_alphabin7.root");
	...
	TFile *f_gg= new TFile("ResonanceShapes_Suu8600_Chi2150_SR_alphabin12.root");
...
TFile *f_qq= new TFile("ResonanceShapes_Suu2000_Chi500_SR_alphabin12.root");
...
TFile *f_qg= new TFile("ResonanceShapes_Suu5000_Chi1250_SR_alphabin12.root");
