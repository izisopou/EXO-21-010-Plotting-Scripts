...
TPaveText *paveCMS = new TPaveText(0.2,0.85,0.4,0.9,"NDC"); //0.25,0.85,0.45,0.9,"NDC"
...
l13->Draw("same");
 ...
 pad67->SaveAs("Figure_2_LHS.C");
 pad67->SaveAs("Figure_2_LHS.png");
 pad67->SaveAs("Figure_2_LHS.pdf");
